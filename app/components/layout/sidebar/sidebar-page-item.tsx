...
export function SidebarPageItem({
  ...
  } else if (mini === false && fullyExpanded) {
    nestedNavigationCollapseSx = {
      ml: 0.5,
      fontSize: 20,
  ...
  const miniNestedNavigationSidebarMeta: SidebarMeta = React.useMemo(() => {
    return {
    ...
    <React.Fragment>
      ...
      >
        ...
        >
              ...
              {mini ? (
                <Typography
                  ...
                  sx={{
                    ...
                    maxWidth: LAYOUT_CONFIG.MINI_DRAWER_WIDTH - 28
                  }}
                >
                  {title}
                </Typography>
          ...
          {action && mini === false && fullyExpanded ? action : null}
          {nestedNavigation ? (
        ...
        {nestedNavigation && mini ? (
          <Grow in={isHovered}>
            <Box
              sx={{
                position: 'fixed',
                left: LAYOUT_CONFIG.MINI_DRAWER_WIDTH - 2,
                pl: '6px'
              }}
            >
              <Paper
              ...
              >
                <SidebarMetaContext.Provider
                  value={miniNestedNavigationSidebarMeta}
                >
                  {nestedNavigation}
                </SidebarMetaContext.Provider>
              </Paper>
