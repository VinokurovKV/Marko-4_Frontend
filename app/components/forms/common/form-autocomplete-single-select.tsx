...
export interface FormAutocompleteSingleSelectProps<
...
export function FormAutocompleteSingleSelect<Value extends number | string>(
  props: FormAutocompleteSingleSelectProps<Value>
) {
