...
export type UpdateCommonTopologyFormDataWithoutConfig = DtoWithoutEnums<
  CodeWrapDto &
    NameUndefinedWrapDto &
    NumUndefinedWrapDto & {
...
export type UpdateCommonTopologyFormData =
  UpdateCommonTopologyFormDataWithoutConfig & {
    [index: string]: any
  }
...
export type UpdateCommonTopologyFormKey = FormKey<UpdateCommonTopologyFormData>

export type UpdateCommonTopologyFormVal = FormVal<UpdateCommonTopologyFormData>

export type UpdateCommonTopologyFormErrors =
  FormValidatorErrors<UpdateCommonTopologyFormData>

export type UpdateCommonTopologyFormErrorsJoined =
  FormValidatorErrorsJoined<UpdateCommonTopologyFormData>

const formValidatorConfig: FormValidatorConfig<UpdateCommonTopologyFormData> = {
  oneField: {
    code: {
      transforms: ['TRIM'],
...
export const updateCommonTopologyFormValidator =
  new FormValidator<UpdateCommonTopologyFormData>(formValidatorConfig)
