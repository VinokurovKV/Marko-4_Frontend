...
export type UpdateTopologyFormData = DtoWithoutEnums<
  CodeWrapDto &
    NameUndefinedWrapDto &
    CommonTopologyIdUndefinedWrapDto &
    VertexNamesUndefinedWrapDto &
...
export type UpdateTopologyFormKey = FormKey<UpdateTopologyFormData>

export type UpdateTopologyFormVal = FormVal<UpdateTopologyFormData>

export type UpdateTopologyFormErrors =
  FormValidatorErrors<UpdateTopologyFormData>

export type UpdateTopologyFormErrorsJoined =
  FormValidatorErrorsJoined<UpdateTopologyFormData>

export const updateTopologyFormValidator =
  new FormValidator<UpdateTopologyFormData>({
    oneField: {
      code: {
        transforms: ['TRIM'],
